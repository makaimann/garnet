...
//	
//
//  Source file: /nobackupkiwi/kongty/AHA/garnet/global_buffer/genesis/global_buffer_int.svp
...
//============================================================================//
logic                        host_wr_en;
logic                        host_to_bank_wr_en [31:0];
logic [BANK_DATA_WIDTH-1:0]  host_to_bank_wr_data [31:0];
logic [BANK_DATA_WIDTH-1:0]  host_to_bank_wr_data_bit_sel [31:0];
logic [BANK_ADDR_WIDTH-1:0]  host_to_bank_wr_addr [31:0];
logic                        host_to_bank_rd_en [31:0];
logic [BANK_DATA_WIDTH-1:0]  bank_to_host_rd_data [31:0];
logic [BANK_ADDR_WIDTH-1:0]  host_to_bank_rd_addr [31:0];
